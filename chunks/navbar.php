<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">KyrgyzFood</a>
		  ...
		  <ul class="sidenav" id="mobile-demo">
	        ...
	        <li><a href="#" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number 05000000000. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
